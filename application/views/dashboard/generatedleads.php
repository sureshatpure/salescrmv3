    ...
    $(document).ready(function ()
    {
        ...
        function setInitialgridsource(grid_data, chart_data, permission)
        {
            ...
            source =
                    {
                        datatype: "json",
                        sortcolumn: 'totalleadcount',
                        sortdirection: 'asc',
                        datafields: [
                            {name: 'empname'},
                            {name: 'createduser'},
                            {name: 'totalleadcount', type: 'int'},
                            {name: 'prospects', type: 'int'},
                            {name: 'met_the_customer', type: 'int'},
                            {name: 'credit_sssessment', type: 'int'},
                            {name: 'sample_trails_formalities', type: 'int'},
                            {name: 'enquiry_offer_negotiation', type: 'int'},
                            {name: 'managing_and_implementation', type: 'int'},
                            {name: 'expanding_and_build_relationship', type: 'int'}
