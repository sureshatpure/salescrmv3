...
<html>
<head>
    <title>jQWidgets with Bootstrap</title>
    <!-- Bootstrap core CSS -->
    ...
    <script type="text/javascript" src="<?= base_url() ?>public/jqwidgets/jqxdatatable.js"></script>
    <script type="text/javascript" src="<?= base_url() ?>public/jqwidgets/jqxtabs.js"></script>
