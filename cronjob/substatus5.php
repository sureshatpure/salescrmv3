...
if (!$conn) {
    ...
    $sql = "SELECT 
						a.mail_alert_id,ld.assignleadchk as executiveid,v.sales_ref_mailid,ld.user_branch,a.leadid,a.lead_substatus_id,a.substatus_updated_date,a.mail_alert_date,a.status_action_type,
