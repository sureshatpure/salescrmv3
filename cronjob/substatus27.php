...
if (!$conn) {
    ...
    $sql = 'SELECT 
						a.order_cancelled_reason as reason,a.mail_alert_id,ld.assignleadchk as executiveid,v.sales_ref_mailid,v."2ND_LVL_MAIL_ID" as bm_mailid,ld.user_branch,a.leadid,a.lead_substatus_id,a.substatus_updated_date,a.mail_alert_date,a.status_action_type,
    ...
    while ($row = pg_fetch_array($result)) {
        ...
        $message .= file_get_contents('email-templates/email-body27.php');
        ...
        // Set the subject
        $mail->Subject = 'Lead Status - Order Cancelled';
        //Set the message
